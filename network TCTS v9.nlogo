...
mean_profitability   ; mean of the gains of vehicles
...
profitability ; ((total_nb_clients_picked_up * 10) - distance_travelled)
capacity_occupation ; maximum number of clients possible
...
to connect.station ;
  ask stations 
  [
    create-links-with stations in-radius max_distance_links with [who != [who] of myself] 
      [
        set color white 
        set thickness 0.02 
      ]
...
to connect.stations.manual ; Creer le reseau (liens entre les stations) en fonction d'une distance choisie par l'utilisateur (slider "max_distance_links")
  ...
  [
    while [mouse-down?]
    [
      let candidate_O min-one-of turtles [distancexy mouse-xcor mouse-ycor]
      if [distancexy mouse-xcor mouse-ycor] of candidate_O < 1 
      [
        set conect.O candidate_O
        watch conect.O 
      ]
      set conect.D min-one-of turtles [distancexy mouse-xcor mouse-ycor]
      while [([distancexy mouse-xcor mouse-ycor] of conect.D > 1) and (conect.D = conect.O)]
      [
        set conect.D min-one-of turtles [distancexy mouse-xcor mouse-ycor]
      ]
      watch conect.D
